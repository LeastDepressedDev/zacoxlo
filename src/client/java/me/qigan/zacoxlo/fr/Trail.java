...
public class Trail extends Module {
    ...
    public void onRegister() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register((mc) -> {
            ...
            if (pos_l.size() > this.cfg().get("Ticks count").getAsInt()) pos_l.removeFirst();

            c_angle+=this.cfg().get("Color shift angle").getAsFloat();
        });
    ...
    public JsonObject sets() {
        ...
        object.addProperty("Ticks count", 200);
        object.addProperty("Color shift angle", 0.05d);
        return object;
    }
}
